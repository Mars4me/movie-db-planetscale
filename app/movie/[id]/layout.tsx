import type { IMovie } from '@/app/interfaces';
...
export default async function MovieId({ params, children }: { children: ReactNode; params: { id: string } }) {
    const data: IMovie = await getData(params.id);
    ...
    return (
        <div className="min-h-screen p-10">
            ...
            <h1 className="pt-5 text-4xl font-bold text-center">{data.title}</h1>
            ...
            <div className="flex mt-10 gap-x-10">
                <div className="w-1/2 font-medium ">
                    ...
                    <h1>
                        <span className="underline">Original Lanugage:</span> {data.original_language}
                    </h1>
